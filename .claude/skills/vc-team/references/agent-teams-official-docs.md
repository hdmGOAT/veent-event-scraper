...
**Subagent types used in this repo:** `general-purpose`, `Explore`, `Plan`, `research-agent`, `execute-agent`, `code-reviewer`, `debugger`, `tester`, `plan-agent`, `update-process-agent`, `innovate-agent`, and more.
